 ...
 * Useful to use in UI. !! Credit to TranekGAS "https://github.com/tranek/GASDocumentation" [NOT MY CODE] - dan :D !!
 */

UCLASS(BlueprintType, meta=(ExposedAsyncProxy = AsyncTask))
class COLLAB09FPS_API UAsyncTaskAttributeChanged : public UBlueprintAsyncActionBase
{
	GENERATED_BODY()
